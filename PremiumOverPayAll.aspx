<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PremiumOverPayAll.aspx.vb" Inherits="mpl.Taj.PremiumOverPayAll" %>
        ...
        <div id="main" class="main_bg">
            ...
            <div id="nav" align="left">
                ...
                <div style="padding: 3px 0 0 20px; line-height: 18px; color: #58595b; "
                    class="plan_info plan_info2 font_set plan_height3">
                    <p>
                        Dear Guest,<br>
                        <br>
                        You have now used the permitted number of devices in the premium tier plan. For
                    ...
                    <p class="plan_note">
                        ...
                        personal devices,-->
                        any additional devices will be chargeable.<br /><span style="margin-top:10px; display:inline-block; font-size:16px; font-family:'sun semibold';"> Taxes Extra as Applicable</span></p>
                    <div id="codevisible5" class="premium_sln">
                        ...
                        <span id="divlsg" class="days_sln" style="display: none"><span>No.Of Days :</span>
                            <asp:TextBox ID="txtLongStay" Width="30" Height="15" BorderColor="Black" runat="server"
                                MaxLength="2"></asp:TextBox>
                            &nbsp;<asp:TextBox ID="txtAmount" Width="70" Height="15" BorderColor="Black" Enabled="false"
                                runat="server" MaxLength="2"></asp:TextBox>&nbsp;+ Taxes </span><span class="style1"
                                    id="planinfospan"></span>
                    </div>
