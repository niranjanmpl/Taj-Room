<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResetPopUpConfirm.aspx.vb" Inherits="mpl.Taj.ResetPopUpConfirm" %>
...
<body>
	...
	<div class="msg_info">
			<h1>Dear Guest,</h1>
			<p style="text-align:justify;">Thank you for changing your password. The password will be the same till the end of your stay. You can reset your password at any time during the stay.</p>
