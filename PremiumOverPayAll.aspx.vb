...
Public Class PremiumOverPayAll
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack() Then
            ...
            If premiumplan <> "" Or premiumplan <> Nothing Then
                ...
                ' lblpremdev1.Text = objPlan.TotalConCurrentDev
            ...
            If IsNothing(UsrCred1) Then
                ...
                ObjElog = LoggerService.gtInstance
                ObjElog.write2LogFile("LoginFlow", vbCrLf & Now() & " -- DeSerialize is EMPTY in PremiumOverPayAll Page" & vbCrLf)
                Response.Redirect("UserError.aspx?finderror=ERROR&ErrorCode=9")
            End If
            ...
            If UsrCred1.Item("roomNo") <> "" And UsrCred1.Item("machineId") <> "" Then
                ObjElog.write2LogFile("LoginFlow", vbCrLf & Now() & " -- Landed Page: PremiumOverPayAll Page -- Room No:" & UsrCred1.Item("roomNo") & " -- MAC:" & UsrCred1.Item("machineId"))
            Else
                ObjElog.write2LogFile("LoginFlow", vbCrLf & Now() & " -- Landed Page: PremiumOverPayAll Page")
            End If
    ...
    '            Dim ObjElog As LoggerService
    '            ObjElog = LoggerService.gtInstance
    '            ObjElog.write2LogFile("LoginFlow", vbCrLf & Now() & " -- DeSerialize is EMPTY in PremiumOverPayAll button click" & vbCrLf)
    '            Response.Redirect("UserError.aspx?finderror=ERROR&ErrorCode=9")
    '        End If
