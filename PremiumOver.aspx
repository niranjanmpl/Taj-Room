<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PremiumOver.aspx.vb" Inherits="mpl.Taj.PremiumOver"  %>   
            ...
            <div id="nav" align="left">
                ...
                <div style="padding: 3px 0 0 20px; line-height: 18px; color: #58595b;" class="plan_info font_set plan_height3">
                    <p>
                        Dear Guest,<br>
                        <br>
                        You have now used the permitted number of devices in the premium tier plan. For additional device please select an additional plan.</p>
                    ...
                    <p class="plan_note">
                        Bandwidth to support video streaming. unlimited email access, etc. with up to <asp:Label ID="lblpremdev" runat="server" Text=""></asp:Label>
                        personal devices at a time, any additional devices will be chargeable. <span style="margin-top:10px; display:inline-block; font-size:16px; font-family:'sun semibold';">Taxes Extra
