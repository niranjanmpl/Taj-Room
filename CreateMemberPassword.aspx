<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreateMemberPassword.aspx.vb" Inherits="mpl.Taj.CreateMemberPassword" %>
            ...
            <div id="nav" align="left">
                ...
                <div style="padding: 0px 0 0 20px; line-height: 18px; color: #58595b;" class="plan_info plan_height3 font_set form_fields">
                    ...
                    <p>
                        ...
                        <label>
                            Password</label>
                        <asp:TextBox ID="txtPassword" runat="server" class="txt_box" TextMode="Password"></asp:TextBox>
                    </p>
                    <p>
                        <label>
                            Confirm Password</label>
                        <asp:TextBox ID="txtConfirmPassword" runat="server" class="txt_box1" TextMode="Password"></asp:TextBox>
                    </p>
                    <p>
                        <label>
                        </label>
                ...
                <div class="call_info height_setter">
                    <p>
                        ...
                        by selecting the respective plan. For any further assistance, <span>Please
