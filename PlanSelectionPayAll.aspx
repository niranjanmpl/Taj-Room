<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PlanSelectionPayAll.aspx.vb"
    Inherits="mpl.Taj.PlanSelectionPayAll" %>
        ...
        <div id="main" class="main_bg">
            <div id="nav" align="left">
                <div class="login_section">
                    Available Plans</div>
                <div style="padding: 2px 0 0 20px; line-height: 15px; color: #636363;" class="plan_info font_set  ">
                    <p>
                    ...
                    <p class="font_set" style="font-weight: normal !important;">
                    ...
                    <p style="padding: 0 12px 0 0px;" class="font_set">
                    ...
                    <div id="codevisible5" class="premium_sln">
                        <asp:DropDownList ID="cmbplans" runat="server" CssClass="select_style select_new"
                            Enabled="false">
                        ...
                        <span class="style1" id="planinfospan"></span><span id="divlsg" class="days_sln"
                            ...
                            <asp:TextBox ID="txtLongStay" Width="30" Height="15" AutoComplete="off" runat="server"
                                MaxLength="2"></asp:TextBox>
                            &nbsp;<asp:TextBox ID="txtAmount" ReadOnly="true" Width="70" Height="15" runat="server"
