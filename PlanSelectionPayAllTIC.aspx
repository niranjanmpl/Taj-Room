<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PlanSelectionPayAllTIC.aspx.vb" Inherits="mpl.Taj.PlanSelectionPayAllTIC" %>
        ...
        <div id="main" class="main_bg">
            ...
            <div id="nav" align="left">
                <div  class="login_section">
                    Available Plans</div>
                <div style="padding: 3px 0 0 20px; line-height: 18px; color: #58595b;  " class="plan_info font_set plan_height2  ">
                    <p>
                        ...
                        <label for="checkbox-1" class="plan_details">
                            ...
                            <b>Standard Plan</b>  <asp:Label ID="lblfreeplanname" runat="server" Text=""></asp:Label></label></p>
                    <p style="padding: 0 12px 0 0px;"  >

                    We value your patronage as a platinum member. As a platinum inner circle member we are delighted to provide you with a 
                    high speed internet band width for <asp:Label ID="lblstandev"
                            runat="server" Text=""></asp:Label> devices with upto 5 Mbps bandwidth.
</p>
                    <p>
                        ...
                        <label for="checkbox-1" class="plan_details">
                            <b>Premium Plan</b>  <asp:Label ID="lblplanname" runat="server" Text=""></asp:Label></label></p>
                    <p style="padding: 0 12px 0 0px;" class="plan_note">
                         This plan comes equipped with the requisite bandwidth to support video streaming, unlimited e-mail access, etc., for up to
                        <asp:Label ID="lblpremdev" runat="server" Text=""></asp:Label> personal devices at a time. Additional devices will be chargeable, with Taxes Extra as applicable.</p>
                        ...
                        </asp:DropDownList><span class="style1" id="planinfospan"> </span>
                          
                         <span id="divlsg" class="days_sln" style ="display:none">    
                           <span> No.Of Days :</span> <asp:textbox id="txtLongStay" Width="30" Height="15"   runat="server" MaxLength="2"></asp:textbox> &nbsp;<asp:textbox id="txtAmount" Enabled="false" Width="70" Height="15" runat="server" MaxLength="2"></asp:textbox>&nbsp; + Taxes
                         </span>
                    ...
                    <p class="btn_pos btn_pos2">
                         <%--<asp:imagebutton id="imgbtnlogin" runat="server" ImageUrl="images/button.jpg" Width="55" Height="22" BorderWidth="0"></asp:imagebutton>--%>
                         <asp:Button ID="imgbtnlogin" runat="server" Text="Login" CssClass="server" />
