<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AutoUpgradePopUp.aspx.vb" Inherits="mpl.Taj.AutoUpgradePopUp" %>
    ...
    <div id="app_wrapper">
        <div class="msg_info">
            ...
            <p style="text-align: justify;">
                Dear Guest, You have requested for password reset. Please create new password. 
                The new password will need to be re-entered for all devices which are logged-in 
                for accessing internet through this service.</p>
