<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreatePasswordAfterReset.aspx.vb" Inherits="mpl.Taj.CreatePasswordAfterReset" %>
    ...
    <div align="center" id="wrapper">
        ...
        <div id="main" class="main_bg">
            <div id="nav" align="left">
                ...
                <div style="padding: 0px 0 0 20px; line-height: 18px; color: #58595b;" class="plan_info plan_height2 plan_height3 font_set form_fields">
                    <p class="font_set2">
            ...
            <p style="display: none;">
                <asp:HyperLink ID="HyperLink1" Target="_new" runat="server" NavigateUrl="ResetPopUpAfterReset.aspx"
                    class="fancybox fancybox.iframe" title="">HyperLink</asp:HyperLink>
            </p>
