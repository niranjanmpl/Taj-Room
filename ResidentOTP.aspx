<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResidentOTP.aspx.vb" Inherits="mpl.Taj.ResidentOTP" %>
        ...
        <div id="main" class="main_bg">
            <div id="nav" align="left">
                ...
                <div style="padding: 20px 0 0 20px; line-height: 20px; width: 100%; color: #58595b;
                    ...
                    <div><p style="font-weight:bold">Dear Mr/Ms. Smith, Please find your details below.</p>
                    <br />
                    </div>
                    <div class="field_Section" style="opacity:0.4">
                    
                        <p>
                            <label>
                                EmailID</label>
                            <asp:TextBox ID="txtroomno" runat="server"  CssClass="txt_box2" Enabled="true" Text="test@xyz.com" ReadOnly="true" ></asp:TextBox>
                        </p>
                        
                        <p>
                            <label>
                                Mobile Number</label>
                            <asp:TextBox ID="txtlastname" runat="server" CssClass="txt_box3" Enabled="false" Text="9916051031" ReadOnly="true"></asp:TextBox>
                        </p>
                    </div>
                   
                    <div class="button_Section">
                       <asp:Button ID="Button1" runat="server" Text="Validation" CssClass="btn_style" BorderWidth="0" style="top:-40px;display:none;" /> 
                        
                   
                        <asp:Button ID="imgbtnlogin" runat="server" Text="Send OTP" CssClass="btn_style" BorderWidth="0" style="display:none" />
                ...
                <div id="OTP" style="padding: 20px 0 0 20px; line-height: 20px; width: 100%; color: #58595b;
                   ...
                   <%-- <p style="font-size:14px; font-family:'Sun SemiBold';"> please enter the OTP which has been sent to your registered mobile.</p><br />
                    ...
                    <p>
                         ...
                         <div class="button_Section spacer1">
                         <label></label>
                        <asp:Button ID="imgotplogin" runat="server" Text="Login" CssClass="btn_style" OnClientClick="javascript:return validate(this);" BorderWidth="0" />&nbsp;
                       <asp:LinkButton ID="BtnResend" runat="server" Text="Resend OTP"></asp:LinkButton>
                        <input value="0" type="hidden" name="hdbutclick" />
                    </div><br />
                </div>
