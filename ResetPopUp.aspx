<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResetPopUp.aspx.vb" Inherits="mpl.Taj.ResetPopUp" %>
...
<body>
	...
	<div class="msg_info">
			<h1>Dear Guest,</h1>
			<p style="text-align:justify;">You have requested for password reset. Please create new password. The new password will need to be re-entered for all devices which are logged-in for accessing internet through this service.</p>
